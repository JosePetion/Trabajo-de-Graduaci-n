...
Pc = 0.8;  % Probabilidad de cruzamiento de 60 a 100%
Pm = 0.15;  % Probabilidad de mutación pequeño, menor que 10%
Maxgen = 100;
Nvar = 2;
epsilon = 0.05;
tipo_funcion = "Banana";
...
elseif strcmp(tipo_funcion, "Booth")
    rango = [-10, -10;
        10, 10];
elseif strcmp(tipo_funcion, "Euclidian")
    rango = [-10, -10;
        10, 10];
end
Mejor = NaN*ones(Maxgen, 1); % Parte de los cambios
...
formatSpec = 'iter: %d - t: %.3f seg - cost: %.3f \n';
